...
export function LocationGuessModal({ open, onClose, onSubmit }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        <p style={{ marginBottom: 12, fontSize: 16, fontWeight: 600, color: theme.colors.text }}>{COPY.locationGuessPlaceholder}</p>
        <Input
          placeholder=""
          value={value}
